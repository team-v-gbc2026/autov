...
// an environment grid).
//
// fire-projectile and lightning-impact are the hand-tuned exemplars, imported
// from their fixtures so there is exactly one copy of those numbers in the
// repository.
// ---------------------------------------------------------------------------
  ...
  return document(
    ...
    [
      ...
      mesh({
        ...
        // The bar runs along local +Z from the muzzle; -PI/2 about Y aims it at -X.
        position: [1.4, 1.1, 0],
