...
- Smoke burst: exported 34 draws, imported and rendered at three viewpoints in both engines. Foreground-union RGB MAE: Godot 0.65–1.69/255; Unity 1.88–2.79/255.
...
Presentation launchers, remaining importer work and product UI verification are in progress. See PROGRESS.md for current evidence and limitations.
