...
> Historical multi-stage implementation, retained for offline regression runs.
> Active Studio orchestration now uses Eve skills and candidate tools; see
> [EVE_INTEGRATION.md](EVE_INTEGRATION.md).
